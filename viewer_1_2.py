...
def delete(folder_path,img_suffix,txt_suffix,o88):
    if img_suffix == '':
        img_suffix = '.png'
...
#       #print(file_txt)
        ...
        delete_from_file(folder_path,txttext, o88)
    
def delete_from_file(folder_path,filename, content1):
    ...
    with gr.Blocks() as iface:#live False
        ...
        with gr.Row():
            ...
            with gr.Column():
                ...
                o99=gr.Textbox(label="Top_txt(REMEMBER THE , !!)")
                button99=gr.Button(value="txt_plus_to_top")
                o88=gr.Textbox(label="Delete_txt(REMEMBER THE , !!)")
                button88=gr.Button(value="txt_delete")
        ...
        button88.click(fn=delete,inputs=[folder_path,img_suffix,txt_suffix,o88],outputs=None)
